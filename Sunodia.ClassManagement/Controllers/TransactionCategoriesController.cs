...
namespace Sunodia.ClassManagement.Controllers
{
    public class TransactionCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Category")] TransactionCategory transactionCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Category")] TransactionCategory transactionCategory)
        {
            if (ModelState.IsValid)
            {
